...
> - 수동 customer carousel 복원 직전 기준선: `752724a2914350d19997a89a45c8cd8400ef4a71` (`refactor: finalize HERO release candidate baseline`)
...
3. Representative Customers (`#proof`)
   - 18개 고객 항목을 별도 semantic HTML trust band의 수동 캐러셀로 표시
   - 모든 항목은 DOM에 유지되며 이전·다음 버튼, 키보드, 터치 스와이프를 지원하고 autoplay는 사용하지 않음
...
- Release Candidate 구조 정리 기준선: `752724a2914350d19997a89a45c8cd8400ef4a71`
- 현재 브랜치: `codex/hero-basepath-stabilization`
